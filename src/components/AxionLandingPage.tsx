...
import { Clock, Menu, X, ArrowRight, Link as LinkIcon, FileText } from 'lucide-react';
  ...
  return (
    <div className="w-full bg-[#EFEFEF] font-sans antialiased text-gray-900 overflow-x-hidden">
      ...
      <section className="relative min-h-screen w-full flex flex-col bg-[#EFEFEF] overflow-hidden">
        ...
        <header className="relative z-30 w-full max-w-[1440px] mx-auto p-2 sm:p-4">
          <nav className="flex items-center justify-between bg-white rounded-full p-2 px-3 sm:px-4 shadow-md border border-gray-200/80 backdrop-blur-md">
            {/* LEFT Logo & Links */}
            <div className="flex items-center gap-6">
              <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-900 rounded-full flex items-center justify-center text-white text-[10px] sm:text-[11px] font-bold tracking-tight shrink-0 shadow-sm">
                AS
              </a>
              <div className="hidden md:flex items-center gap-6 text-[14px] font-medium text-gray-900">
                <a href="#about" className="hover:text-[#F26522] transition-colors duration-300">About</a>
                <a href="#skills" className="hover:text-[#F26522] transition-colors duration-300">Skills</a>
                <a href="#projects" className="hover:text-[#F26522] transition-colors duration-300">Projects</a>
                <a href="#certifications" className="hover:text-[#F26522] transition-colors duration-300">Certifications</a>
                <a href="#connect" className="hover:text-[#F26522] transition-colors duration-300">Connect</a>
              </div>
            </div>
            ...
            <button
              ...
              className="md:hidden w-9 h-9 bg-gray-900 rounded-full flex items-center justify-center text-white shadow-sm"
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/60 backdrop-blur-sm md:hidden animate-in fade-in duration-300">
            <div className="bg-white rounded-2xl mx-3 mb-3 p-6 flex flex-col gap-6 animate-in slide-in-from-bottom duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]">
              ...
              <div className="flex flex-col gap-4 text-[24px] font-medium text-gray-900">
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-end max-w-[1440px] w-full mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5">
            ...
            <div 
              onClick={onOpenResume}
              className="bg-white rounded-[4px] px-3.5 py-2.5 flex items-center gap-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-shadow duration-300 cursor-pointer"
            >
      ...
      <section id="projects" className="bg-[#F5F5F5] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="px-5 sm:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
            {/* Card 1: WorkSure Verification Platform */}
            ...
            {/* Card 2: Hospital Bed Management System */}
            <div className="flex flex-col">
