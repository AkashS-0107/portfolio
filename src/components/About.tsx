  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal>
          <div className="mb-3">
            <span className="text-rose-400 text-xs font-semibold tracking-wider uppercase font-mono">Overview & Background</span>
          </div>
        ...
        <div className="space-y-5">
          <ScrollReveal delay={100}>
            ...
            >
              <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
                ...
                <div className="pt-4 border-t border-rose-900/40 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-slate-400 font-mono">
                  <div className="flex items-center gap-2 p-2.5 rounded-lg bg-slate-950/80 border border-slate-800">
          ...
          <ScrollReveal delay={200}>
            ...
            >
              <div className="space-y-5">
                <SpotlightCard className="p-6 border-rose-900/40">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                    ...
                    <span className="px-3 py-1 rounded bg-rose-950 border border-rose-800/60 text-rose-300 text-xs font-mono">
                      Expected Grad: May 2028
                    </span>
                  </div>
                  <p className="text-sm text-slate-400 mb-3">SRM Institute of Science and Technology, Ramapuram Campus</p>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-950 border border-slate-800 text-slate-300 text-xs font-mono">
                    Specializing in Artificial Intelligence & Machine Learning • CGPA 7.10
                  </div>
                </SpotlightCard>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800">
                    <span className="text-xs text-rose-400 uppercase tracking-wider font-mono">Higher Secondary (12th Grade)</span>
                    <div className="text-base font-bold text-white mt-1">64.33% Secured</div>
                    <p className="text-xs text-slate-400 mt-1">Senior Secondary Board Examination</p>
                  </div>
                  <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800">
                    <span className="text-xs text-rose-400 uppercase tracking-wider font-mono">Secondary (10th Grade)</span>
                    <div className="text-base font-bold text-white mt-1">73.00% Secured</div>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {competencies.map((item, idx) => (
                  <SpotlightCard key={idx} className="p-4 border-rose-900/30">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-lg bg-slate-950 border border-rose-900/60 text-rose-400">
